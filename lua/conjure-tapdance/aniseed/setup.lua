...
local _2amodule_name_2a = "conjure-tapdance.aniseed.setup"
local _2amodule_2a
do
...
local a, env, eval, nvim = autoload("conjure-tapdance.aniseed.core"), autoload("conjure-tapdance.aniseed.env"), autoload("conjure-tapdance.aniseed.eval"), autoload("conjure-tapdance.aniseed.nvim")
