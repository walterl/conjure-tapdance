...
local _2amodule_name_2a = "conjure-tapdance.aniseed.fennel"
local _2amodule_2a
do
...
local a, fs, nvim, str = autoload("conjure-tapdance.aniseed.core"), autoload("conjure-tapdance.aniseed.fs"), autoload("conjure-tapdance.aniseed.nvim"), autoload("conjure-tapdance.aniseed.string")
...
local function impl()
  local compiler = require("conjure-tapdance.aniseed.deps.fennel")
