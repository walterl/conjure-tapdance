...
local _2amodule_name_2a = "conjure-tapdance.aniseed.env"
local _2amodule_2a
do
...
local compile, fennel, fs, nvim = autoload("conjure-tapdance.aniseed.compile"), autoload("conjure-tapdance.aniseed.fennel"), autoload("conjure-tapdance.aniseed.fs"), autoload("conjure-tapdance.aniseed.nvim")
