...
local _2amodule_name_2a = "conjure-tapdance.aniseed.compile"
local _2amodule_2a
do
...
local a, fennel, fs, nvim = autoload("conjure-tapdance.aniseed.core"), autoload("conjure-tapdance.aniseed.fennel"), autoload("conjure-tapdance.aniseed.fs"), autoload("conjure-tapdance.aniseed.nvim")
do end (_2amodule_locals_2a)["a"] = a
_2amodule_locals_2a["fennel"] = fennel
_2amodule_locals_2a["fs"] = fs
_2amodule_locals_2a["nvim"] = nvim
local function wrap_macros(code, opts)
  local macros_module = "conjure-tapdance.aniseed.macros"
  local filename
  do
